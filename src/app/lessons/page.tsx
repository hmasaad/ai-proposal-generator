...
import { loadLessons, removeLesson } from "@/lib/storage";
  ...
  return (
    <div className="min-h-screen">
      ...
      <main className="mx-auto max-w-3xl px-6 py-10">
        ...
        <h1 className="mt-3 font-serif text-4xl tracking-tight">What we learned</h1>
        <p className="mt-3 max-w-2xl text-[15px] leading-7 text-ink-soft">
          Logged mistakes and finished proposals are chunked, embedded, and stored in a local
          vector index. The next generation retrieves the closest chunks and the model has to
          apply them.
        </p>
        {chunkCount !== null && (
